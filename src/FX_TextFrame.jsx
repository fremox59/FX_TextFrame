//ColorPicker v2.0 for Adobe scripting library
;(function(){
    /*
...
(function (thisObj) {
    ...
    function singleTextFrameMask(cornerType, fillColor, strokeColor, selectedAnim, selectedFixedDim, selectedComposit,shiftIsPressed,AltIsPressed) {
        ...
        if (compLayers.length == 0) {
            ...
            if (selectedComposit == 0) {
                ...
                var easeIn = new KeyframeEase(100, 0.1);
                var easeOut = new KeyframeEase(0.1, 100);
                var easeIn2 = new KeyframeEase(0.1, 0.1);
                var easeOut2 = new KeyframeEase(0.1, 0.1);
            if(shiftIsPressed == false && AltIsPressed ==true){
                myTxtMaskLayer.effect("FX TextFrame")("Animation Keyframes").setValueAtKey(1,100);
                myTxtMaskLayer.effect("FX TextFrame")("Animation Keyframes").setValueAtKey(2,0);
                myTxtMaskLayer.effect("FX TextFrame")("Animation Keyframes").setTemporalEaseAtKey(1, [easeIn], [easeOut]);
                myTxtMaskLayer.effect("FX TextFrame")("Animation Keyframes").setTemporalEaseAtKey(2, [easeIn2], [easeOut2]);
            }else if(shiftIsPressed == true && AltIsPressed ==true){
                myTxtMaskLayer.effect("FX TextFrame")("Animation Keyframes").setValueAtTime(myTxtMaskLayer.effect("FX TextFrame")("Animation Keyframes").keyTime(2)+1.8,100);
                myTxtMaskLayer.effect("FX TextFrame")("Animation Keyframes").setValueAtTime(myTxtMaskLayer.effect("FX TextFrame")("Animation Keyframes").keyTime(3)+0.8,0);
                myTxtMaskLayer.effect("FX TextFrame")("Animation Keyframes").setTemporalEaseAtKey(1, [easeIn2], [easeOut2]);
                myTxtMaskLayer.effect("FX TextFrame")("Animation Keyframes").setTemporalEaseAtKey(3, [easeIn], [easeOut]);
                myTxtMaskLayer.effect("FX TextFrame")("Animation Keyframes").setTemporalEaseAtKey(4, [easeIn2], [easeOut2]);
                myTxtMaskLayer.effect("FX TextFrame")("Flip Opening Direction").setValueAtTime(myTxtMaskLayer.effect("FX TextFrame")("Animation Keyframes").keyTime(1),myTxtMaskLayer.effect("FX TextFrame")("Flip Opening Direction").value);
                myTxtMaskLayer.effect("FX TextFrame")("Flip Opening Direction").setValueAtTime(myTxtMaskLayer.effect("FX TextFrame")("Animation Keyframes").keyTime(3),1-myTxtMaskLayer.effect("FX TextFrame")("Flip Opening Direction").value);
            }else{
                myTxtMaskLayer.effect("FX TextFrame")("Animation Keyframes").setTemporalEaseAtKey(1, [easeIn2], [easeOut2]);
            }
    ...
    function singleTextFrameShape(cornerType, fillColor, strokeColor, selectedAnim, selectedFixedDim, selectedComposit,shiftIsPressed,AltIsPressed) {
        var myComp = app.project.activeItem;
        var compLayers = myComp.selectedLayers;
        var touches = detect();
        ...
        if (compLayers.length == 0) {
            ...
            if (selectedComposit == 0) {
                ...
                var easeOut2 = new KeyframeEase(0.1, 0.1);
            if(shiftIsPressed == false && AltIsPressed ==true){
                myNewFXlayer.effect("FX TextFrame")("Animation Keyframes").setValueAtKey(1,100);
                myNewFXlayer.effect("FX TextFrame")("Animation Keyframes").setValueAtKey(2,0);
                myNewFXlayer.effect("FX TextFrame")("Animation Keyframes").setTemporalEaseAtKey(1, [easeIn], [easeOut]);
                myNewFXlayer.effect("FX TextFrame")("Animation Keyframes").setTemporalEaseAtKey(2, [easeIn2], [easeOut2]);
            }else if(shiftIsPressed == true && AltIsPressed ==true){
                myNewFXlayer.effect("FX TextFrame")("Animation Keyframes").setValueAtTime(myNewFXlayer.effect("FX TextFrame")("Animation Keyframes").keyTime(2)+1.8,100);
                myNewFXlayer.effect("FX TextFrame")("Animation Keyframes").setValueAtTime(myNewFXlayer.effect("FX TextFrame")("Animation Keyframes").keyTime(3)+0.8,0);
                myNewFXlayer.effect("FX TextFrame")("Animation Keyframes").setTemporalEaseAtKey(1, [easeIn2], [easeOut2]);
                myNewFXlayer.effect("FX TextFrame")("Animation Keyframes").setTemporalEaseAtKey(3, [easeIn], [easeOut]);
                myNewFXlayer.effect("FX TextFrame")("Animation Keyframes").setTemporalEaseAtKey(4, [easeIn2], [easeOut2]);
                myNewFXlayer.effect("FX TextFrame")("Flip Opening Direction").setValueAtTime(myNewFXlayer.effect("FX TextFrame")("Animation Keyframes").keyTime(1),myNewFXlayer.effect("FX TextFrame")("Flip Opening Direction").value);
                myNewFXlayer.effect("FX TextFrame")("Flip Opening Direction").setValueAtTime(myNewFXlayer.effect("FX TextFrame")("Animation Keyframes").keyTime(3),1-myNewFXlayer.effect("FX TextFrame")("Flip Opening Direction").value);
            }else{
                myNewFXlayer.effect("FX TextFrame")("Animation Keyframes").setTemporalEaseAtKey(1, [easeIn2], [easeOut2]);
            }
    ...
    function lower3rdRig(cornerType, fillColor, strokeColor, selectedAnim, selectedFixedDim, selectedComposit) {
        ...
        create_btn.onClick = function () {
            ...
            var presetPath2 = myAssetsPath + "/presets/FX_MultiLine_TextFrame3.ffx";
            ...
            if (toggleMode.value == false) {
                ...
                var presetPath = myAssetsPath + "/presets/FX_multiTextFrame_Mask4.ffx";
                var myPreset = File(presetPath);
                ...
                for (var n = 0; n < maingroup.children.length; n++) {
                    ...
                    if (selectedAnim == 0) {
                        ...
                        myRigCTRLLayer.effect("FX Multiline TextFrame")("Lines Horizontal Alignement").setValue(0);
                        myRigCTRLLayer.effect("FX Multiline TextFrame")("Multi Opening Direction").setValue(2);
                    } else if (selectedAnim == 1) {
                        myRigCTRLLayer.effect("FX Multiline TextFrame")("Lines Horizontal Alignement").setValue(-100);
                ...
                var presetPath4 = myAssetsPath + "/presets/FX_multiTextFrame_ShapeText2.ffx";
                ...
                myNewFXlayer.effect("FX TextFrame")("Frame Margin X").expression = "parent.parent.effect('FX Multiline TextFrame')('Frames Margins X')";
    ...
    function infos(singleTab) {
        ...
        var button1 = linkButtonsGroup.add ("button", undefined, "Support Free and OpenSource software");
        var button2 = linkButtonsGroup.add ("button", undefined, "More about Fremox, author of the tool");
        var button3 = linkButtonsGroup.add ("button", undefined, "Close");

        var myURL1 = "https://rxlaboratorio.org/donate/" ;
        var myURL2 = "https://fremox.bio.link/" ;
    ...
    //////////////////////////////////////////////////// 
    var toggleMode = iconsGroup.add("iconbutton", undefined, File(myAssetsPath + "/icons/UI_icons/toggle_Shape_mode.png"), {
        style: "toolbutton",
        toggle: false
    });
    ...
    var btnMultipleCreate = multipleButtonsGroup.add("button", undefined, "Setup multiline FX TxtFr");
    ...
    var btnBakePath2 = bakingSubGroup2.add("button", undefined, "Bake path on selected FX TxtFr");
    ...
    btnSingleCreate.onClick = function () {
        ...
        if (toggleMode.value == false) {
            singleTextFrameMask(myList.selection, hexToColor(textColorLabel1.text), hexToColor(textColorLabel2.text), myList2.selection, myList3.selection, myList4.selection,isShift,isAlt);
        } else {
            singleTextFrameShape(myList.selection, hexToColor(textColorLabel1.text), hexToColor(textColorLabel2.text), myList2.selection, myList3.selection, myList4.selection,isShift,isAlt);
        }
        app.endUndoGroup();
    };
